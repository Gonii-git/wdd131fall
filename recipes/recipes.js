...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Template to display recipe details
        ...
        return `
            <figure class="recipe">
                ...
                <figcaption>
                    ...
                    <p><strong>Instructions:</strong> ${recipe.recipeInstructions.join(' ')}</p>
                </figcaption>
            </figure>
        `;
    }
    ...
    function ratingTemplate(rating) {
        ...
        return `<span role="img" aria-label="Rating: ${rating} out of 5 stars">${stars}</span>`;
    }

    // Render recipes
    function renderRecipes(recipeList) {
        const recipesList = document.getElementById('recipesList');
        recipesList.innerHTML = recipeList.map(recipeTemplate).join('');
    }
